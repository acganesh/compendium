...
\hypersetup{
  pdfauthor={Adithya C. Ganesh},
  pdftitle={Stanford Compendium},
...
%====================%
%  End of CTFP preamble.  %
%====================%

% Adi's additions here:
\usepackage[english]{babel}

\usepackage{todonotes}

\newcommand{\T}{\texttt}
% This is annoying - use consistent macro set
...
% There's an error with ``\* already defined''
